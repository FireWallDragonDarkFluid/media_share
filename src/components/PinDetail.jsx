      ...
      <div className='w-full p-5 flex-1 xl:min-w-620'>
        ...
        <div className='flex flex-wrap mt-5 gap-3'>
          <Link to={`/user-profile/${pinDetail.postedBy?._id}`}>
            <img className='w-10 h-10 rounded-full cursor-pointer object-cover' 
